...
let slidersMain = document.querySelectorAll('.product__left');

if(slidersMain){
	for (let i = 0; i < slidersMain.length; i++) {
		let slider1 = slidersMain[i].querySelector(".product__slider");
		let slider2 = slidersMain[i].querySelector(".product__slider2");
		//   alert(blocksafasf.classList) 
		let buttonMainPrev = slidersMain[i].querySelector(".product-button-prev");
		let buttonMainNext = slidersMain[i].querySelector(".product-button-next");
		init_sliderMain(slider1, slider2, buttonMainPrev, buttonMainNext);
	}
}


function init_sliderMain(slider1, slider2,  prev, next){
...
// let slider_about = new Swiper('.mySwiper2', {
// 	/*
// 	effect: 'fade',
// 	autoplay: {
// 		delay: 3000,
...
// var swipsafasfer = new Swiper(".mySwiper", {
// 	loop: true,
// 	spaceBetween: 10,
// 	slidesPerView: 3,
// 	freeMode: true,
